...
const About = () => {
  ...
  return (
    <>
      <div className="flex justify-between items-center text-xl font-bold mb-2 row-start-1 col-span-9 md:text-3xl lg:col-start-4 lg:col-span-5">
        <div>
          hi, im Lip Wei&nbsp;
          <span className={classes.wave}>👋</span>
        </div>
      </div>
      <div className="row-start-3 col-span-9 lg:col-span-5 lg:col-start-4">
        <div className="flex gap-x-4">
          <a href="/files/resume.pdf" target="blank" aria-label="Resume">
            <svg
              height="2rem"
              width="2rem"
              version="1.1"
          ...
          <a href="https://www.github.com/lipwei1808" target="blank" aria-label="Github">
            <svg
              className="hover:fill-white cursor-pointer transition"
              xmlns="http://www.w3.org/2000/svg"
              width="2rem"
          ...
          <a href="mailto:tlipwei@gmail.com" aria-label="Email">
            <svg
              className="hover:fill-white cursor-pointer transition"
              fill="#000000"
              viewBox="0 0 22 22"
          ...
          <a href="https://www.linkedin.com/in/tanlipwei" target="blank" aria-label="Linkedin">
            <svg
              className="hover:fill-white cursor-pointer transition"
              xmlns="http://www.w3.org/2000/svg"
              width="2rem"
          ...
          <a href="https://www.instagram.com/lipwei.tan" target="blank" aria-label="Instagram">
            <svg
              className="hover:fill-white cursor-pointer transition"
              xmlns="http://www.w3.org/2000/svg"
              width="2rem"
      ...
      <div className="inline-block row-start-2 overflow-hidden whitespace-nowrap relative col-span-9 lg:col-start-4 lg:col-span-5">
        i&nbsp;
